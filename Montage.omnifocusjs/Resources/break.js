...
(() => {
    var action = new PlugIn.Action(async () => {
        try {
            ...
            focusForm.addField(new Form.Field.String("description", "Description", "Break"));
            ...
            new Alert("Started break", `Started break for ${Math.round(minutes / 60)} minutes, until ${endTime.getHours()}:${endTime.getMinutes()}`).show();
        }
        catch (err) {
            console.error(err);
        }
