// TypeScript definitions for OmniFocus 3.11.7 (149.14) on macOS 11.4
...
declare class Folder extends ActiveObject {
  constructor(
    name: string,
    position: Folder | Folder.ChildInsertionLocation | null
  );
  folderNamed(name: string): Folder | null;
  projectNamed(name: string): Project | null;
...
declare namespace Task {
  function byParsingTransportText(
    text: string,
    singleTask: boolean | null
  ): Array<Task>;
...
declare class Task extends ActiveObject {
  constructor(
    name: string,
    position: Project | Task | Task.ChildInsertionLocation | null
  );
  taskNamed(name: string): Task | null;
...
declare namespace Formatter.Date {
  function withStyle(
    dateStyle: Formatter.Date.Style,
    timeStyle: Formatter.Date.Style | null
  ): Formatter.Date;
...
declare class Text {
  ...
  ranges(
    ...
    useEnclosingRange: boolean | null
  ): Array<Text.Range>;
  ...
  find(
    string: string,
    options: Array<Text.FindOption> | null,
